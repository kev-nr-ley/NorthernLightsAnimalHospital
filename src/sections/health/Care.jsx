      ...
      <ImageTextPill
        ...
        <Flex flexDirection={"column"}>
          <Text>
            ...
            series to be fully vaccinated. Be sure to follow all your
            veterinarian’s recommendations and make sure to schedule an
            appointment with your veterinarian soon after acquiring your new
            pet. Pets are susceptible to viral and bacterial diseases at any age
          ...
          <Accordion allowToggle>
            <AccordionQuestion
              ...
              <Text listStylePosition={"inside"}>
                ...
                should start receiving vaccinations as young as 8 weeks old,
                your veterinarian can help you develop the proper protocol for
                your animal. The following vaccines (DA2PP and Rabies) are
                considered core and are always recommended to be kept up to
                date:
            ...
            <AccordionQuestion
              ...
              <Text>
                ...
                lifestyle that will be considered is whether they are strictly
                an indoor cat compared to a free-roaming outdoor cat. It is
                essential to remember your kitten should start receiving
                vaccinations as young as 8 weeks old, your veterinarian can help
                you develop the proper protocol for your animal. The following
                vaccines are considered core and are always recommended to be
                kept up to date:
                <li>Feline Viral Rhinotracheitis</li>
                <li>Calicivirus</li>
                <li>Panleukopenia</li>
                <li>Rabies</li>
                The following vaccine is optional but always recommended for
                cats that freely roam outdoors or in are in homes where new cats
